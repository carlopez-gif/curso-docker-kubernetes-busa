# Docker & Kubernetes: Contenedores y Orquestación en la Práctica

Repositorio oficial del curso de **i-Quattro** enfocado en el uso profesional de contenedores con Docker y su orquestación con Kubernetes.
...
Formar a los participantes en el uso de contenedores con Docker y su orquestación con Kubernetes, aplicando buenas prácticas de deployment, escalabilidad y observabilidad en entornos productivos.
...
2. Manejo de imágenes, contenedores y redes
...
**Bloque 1 (Docker):**
- **Docker Desktop** (Windows/macOS) o **Docker Engine** (Linux/AlmaLinux) - [Guía de instalación](INSTALL_DOCKER.md)
...
**Bloque 2 (Kubernetes):**
- **minikube** - Cluster local de Kubernetes (usado en clases 6-8)
- **kubectl** - CLI de Kubernetes
- [Guía de instalación Kubernetes](INSTALL_KUBERNETES.md)

**Nota:** Las guías de instalación incluyen instrucciones para AlmaLinux 10, Ubuntu y otros sistemas.

### Configuraciones soportadas para el curso

Los estudiantes pueden usar cualquiera de estas configuraciones:

1. **Windows 10/11 + WSL2 + AlmaLinux 10** (sin GUI) - Recomendado para Windows
2. **Windows 10/11 + VirtualBox + AlmaLinux 10** (servidor mínimo)
3. **AlmaLinux 10** como sistema operativo base
4. **Ubuntu 24.04 LTS** (nativo o en VM)
5. **macOS** con Docker Desktop

**[Guía de instalación WSL2 + AlmaLinux 10](INSTALL_WSL.md)**
