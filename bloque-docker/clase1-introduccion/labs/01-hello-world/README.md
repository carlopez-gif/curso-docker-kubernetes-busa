...
Validar la instalación de Docker ejecutando tu primer contenedor y comprender el flujo básico de ejecución.
...
- **Imagen** - Plantilla de solo lectura con el software y dependencias
