...
Explorar Docker Hub, el registro público de imágenes de Docker, comprender cómo encontrar imágenes oficiales, leer su documentación y seleccionar tags (versiones) apropiados.
