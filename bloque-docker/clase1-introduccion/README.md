# Clase 1 – Introducción a Contenedores y Docker

En esta clase nos enfocaremos en **los fundamentos de Docker**, ejecutaremos nuestros **primeros contenedores** y exploraremos el ecosistema de imágenes oficiales.

---

## Objetivos de aprendizaje
- Comprender qué es Docker y en qué se diferencia de las máquinas virtuales
- Ejecutar el primer contenedor (*hello-world*) y un servicio web (Nginx)
- Conocer y practicar comandos básicos de Docker
- Explorar Docker Hub para descubrir imágenes oficiales
...
- **Contenedor**: Proceso aislado que comparte el kernel del sistema operativo
- **VM**: Sistema operativo completo virtualizado con su propio kernel
- Los contenedores son más ligeros, rápidos de iniciar y eficientes en recursos

### Docker Components
- **Docker Engine**: Runtime que ejecuta contenedores
- **Imagen**: Template read-only, blueprint de un contenedor
