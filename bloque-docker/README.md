...
Este bloque cubre los fundamentos y uso avanzado de Docker, desde la creación y administración de contenedores hasta la orquestación con Docker Compose y buenas prácticas de seguridad.
...
- Comprender la arquitectura de Docker y contenedores
- Crear, administrar y debuggear contenedores
- Trabajar con imágenes, Dockerfile y registries
...
### [Clase 1: Introducción a Contenedores y Docker](clase1-introduccion/)
