...
En esta clase aprenderemos a crear nuestras propias imágenes Docker mediante Dockerfiles, aplicando técnicas de optimización como multi-stage builds.
...
- **Imagen**: Plantilla read-only con el sistema de archivos y configuración para ejecutar una aplicación
- **Contenedor**: Instancia en ejecución de una imagen
- Una imagen puede generar múltiples contenedores
- Imágenes se componen de capas apiladas (layered filesystem)
- Relación análoga: Clase e imagen vs Objeto y contenedor en POO
...
Práctica de 5 minutos para consolidar lo aprendido.
