...
Aprender a crear una imagen Docker personalizada para servir contenido HTML estático utilizando Nginx, aplicando conceptos de copia de archivos, configuración personalizada y exposición de puertos no estándar.
...
| `EXPOSE 8089` | Documenta que el contenedor escuchará en el puerto 8089 (no estándar) |
...
# Opción 2: Detener el container que está usando el puerto
docker ps
...
1. Verifica que `styles.css` esté en `static-html-directory/`
...
**Solución:** Reconstruye la imagen asegurándote de que todos los archivos estén presentes.
